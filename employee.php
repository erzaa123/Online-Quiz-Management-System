  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==13) echo'class="active"'; ?>><a href="employee.php?q=13">Employee</a></li>
                    ...
                    <tbody>
                        ...
                        while ($row = $query->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>{$row['Surname']}</td>
                                    <td>
                                        <a href='#edit_{$row['EmployeeId']}' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>
                                        <a href='#delete_{$row['EmployeeId']}' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
                                    </td>
                                  </tr>";
