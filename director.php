  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==10) echo'class="active"'; ?>><a href="ashensori.php?q=10">Satelit</a></li>
        <li <?php if(@$_GET['q']==11) echo'class="active"'; ?>><a href="director.php?q=11">Director</a></li>
        <li <?php if(@$_GET['q']==12) echo'class="active"'; ?>><a href="movie.php?q=12">Movie</a></li>
...
<head>
    ...
    <title>CRUD Operation with DataTable and PDF Generator</title>
                    ...
                    <tbody>
                        ...
                        while ($row = $query->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>{$row['BirthYear']}</td>
                                    <td>
                                        <a href='#edit_{$row['DirectorId']}' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>
                                        <a href='#delete_{$row['DirectorId']}' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
                                    </td>
                                  </tr>";
                            include('edit_delete_modal_director.php');
                        }
                        ?>
                    </tbody>
                </table>
...
<?php include('add_modal_director.php') ?>
