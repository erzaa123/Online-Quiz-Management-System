        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="row">
                <form id="filterForm">
                    ...
                    <select id="directorFilter" name="DirectorId" class="form-control" onchange="filterMovies()">
            ...
            <div class="row">
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        include('edit_delete_modal_movie.php');
                    }
                    ?>
                    </tbody>
                </table>
...
<?php include('add_modal_movie.php'); ?>
...
<script>
    ...
    function filterMovies() {
        var directorId = $('#directorFilter').val();
        $.ajax({
